...
public interface ITransactionsRepository extends JpaRepository<Transaction, Long> {
    ...
    List<Transaction> findTransactionsWithinDateRange(@Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate, @Param("idAccount") Long idAccount);
